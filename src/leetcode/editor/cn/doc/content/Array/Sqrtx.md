...
<div><div>Related Topics</div><div><li>数学</li><li>二分查找</li></div></div><br><div><li>👍 970</li><li>👎 0</li></div>
<p></p>
<div>left初始化是1，target是x/middle，target == middle时return middle，否则return right</div>